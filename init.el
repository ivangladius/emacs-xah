...
(load "~/.emacs.d/workgroups-config")


;;(load "~/.emacs.d/stumpwm-config")
...
;; (load "~/.emacs.d/lsp-config")

(load "~/.emacs.d/ggtags-config")

;; LISP

(load "~/.emacs.d/lisp-config")
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lispy slime workgroups paredit parent-mode god-mode ranger rainbow-delimiters rainbow-mode ace-window counsel swiper ivy orderless vertico use-package bind-key stumpwm-mode auto-sudoedit lsp-mode company-c-headers tree-sitter-langs tree-sitter rust-mode ggtags smex helm-cscope company gruvbox-theme solarized-theme vterm competitive-programming-snippets rtags magit projectile which-key quickrun xah-fly-keys helm))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :extend nil :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 150 :width normal :foundry "Xos4" :family "Terminus")))))
